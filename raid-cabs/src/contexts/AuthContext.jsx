...
export function AuthProvider({ children }) {
  ...
  async function signIn({ email, password }) {
    ...
    if (result.error) {
      ...
      if (m.includes('Email not confirmed'))     result.error.message = 'Email not confirmed. Use Email OTP login instead.'
      if (m.includes('Invalid login credentials')) result.error.message = 'Wrong email or password.'
    }
    return result
  }
  ...
  async function signInWithPhone({ phone, password }) {
    ...
    if (result.error?.message?.includes('Invalid login credentials'))
      result.error.message = 'Wrong phone number or password.'
    return result
  }
