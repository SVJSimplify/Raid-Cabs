          ...
          {driver && (
            <div className="card mb3">
              ...
              <div style={{ display:'flex', alignItems:'center', gap:'.9rem' }}>
                <div style={{ width:52, height:52, borderRadius:'50%', background:'linear-gradient(135deg,var(--gold),var(--orange))', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:'var(--fd)', fontWeight:700, color:'#05050e', flexShrink:0, fontSize:'1.1rem', overflow:'hidden', border:'2px solid var(--b2)' }}>
                  {driver.photo_url
