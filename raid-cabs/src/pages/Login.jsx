...
export default function Login() {
  ...
  // renderPwField — inline, not a component (prevents focus loss on re-render)
  const renderPwField = (acMode) => (
    <div className="fg">
      ...
      <div className="input-wrap" style={{ position:'relative' }}>
        ...
        <input
          ...
          name="password"
          id="pw-field"
          autoComplete={acMode || (subMode === 'login' ? 'current-password' : 'new-password')}
