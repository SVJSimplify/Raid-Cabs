...
export default function EmergencySetup() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'var(--bg)', display:'flex', alignItems:'center', justifyContent:'center', padding:'2rem', fontFamily:'var(--fb)', position:'relative', overflow:'hidden' }}>
