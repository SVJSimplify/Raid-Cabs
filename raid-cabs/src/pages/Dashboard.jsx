    ...
    <div className="main" style={{ padding:'2.5rem 2rem' }}>
      ...
      <div className="ac-grid">
        ...
        <div className="ac bk fu d2" onClick={()=>navigate('/book')}>
          ...
          <p style={{ color:'var(--ts)',fontSize:'.84rem',lineHeight:1.65,marginBottom:'1.25rem' }}>Real road distance via Mappls, live driver tracking, ETA countdown, and address autocomplete.</p>
