...
const TABS = [['overview','Overview',BarChart2],['discounts','Discounts',CreditCard],['deposits','Deposits',Package],['drivers','Drivers',Car],['bookings','Bookings',Settings],['users','Users',Users]]
...
export default function OpsDashboard() {
  ...
  const load = useCallback(async () => {
    ...
    setData({ tiers:t.data||[], drivers:d.data||[], bookings:b.data||[], deposits:dep.data||[], users:u.data||[] })
  }, [])
