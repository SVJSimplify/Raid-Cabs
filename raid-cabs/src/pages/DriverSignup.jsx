...
export default function DriverSignup() {
  ...
  const formOk     = form.name && form.phone.replace(/\D/g,'').length>=10 && plateValid && form.vehicle_model && photoFile && govFile
  ...
  if (done) return (
    <div className="main" style={{padding:'4rem 2rem',display:'flex',justifyContent:'center'}}>
      <div style={{maxWidth:460,width:'100%',textAlign:'center'}}>
        ...
        <p style={{color:'var(--ts)',lineHeight:1.75,marginBottom:'2rem'}}>Admin will review your application and documents. You'll receive a PIN when approved.</p>
      ...
      <div style={{maxWidth:560,margin:'0 auto'}}>
        ...
        <div className="card fu">
          <form onSubmit={handleSubmit} style={{display:'flex',flexDirection:'column',gap:'1.5rem'}}>
            ...
            <div className="info-box"><Clock size={14} style={{flexShrink:0}}/> Application sent to admin for review. You'll get a PIN when approved to log in at the Driver Portal.</div>
