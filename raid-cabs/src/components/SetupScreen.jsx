...
VITE_MAPPLS_KEY=your_mappls_key
VITE_UPI_ID=yourname@upi`}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
          ...
          <a href="https://auth.mappls.com/console" target="_blank" rel="noreferrer"
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, padding: '.72rem 1.4rem', background: 'transparent', color: '#ffb347', border: '1px solid rgba(255,179,71,.3)', borderRadius: 10, fontWeight: 700, fontSize: '.88rem', textDecoration: 'none' }}>
            Get Mappls Key →
          </a>
        </div>
